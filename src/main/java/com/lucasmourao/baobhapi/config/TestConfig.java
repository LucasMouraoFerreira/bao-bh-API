...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... agrs) throws Exception{
		...
		Place place1 = new Place(null, "Zoologico", "Lugar para ver animais", "Rua Otacilio Negrão de Lima", businessHours, 4.5, 5L, Region.PAMPULHA,-19.854830, -44.005465);
		Place place2 = new Place(null, "Parque Ecologico", "Contato com a natureza", "Rua Otacilio Negrão de Lima", businessHours, 4.7, 10L, Region.PAMPULHA, -19.852553, -43.992753);
